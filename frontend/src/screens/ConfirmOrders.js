          ...
          <div className="md:hidden flex mb-5 justify-center">
            ...
            <div className="md:grid md:grid-cols-4 md:gap-16 mx-3 md:mx-0">
              <div className="col-span-3">
                <h2 className="text-xl md:text-2xl font-semibold text-blue-900">Shipping Info</h2>
                ...
                <h2 className="md:text-2xl text-xl text-blue-900 font-semibold mt-1">Your Cart Items</h2>
              ...
              <div className="col-span-1">
                <div className="main">
                  <div className="bg-gray-900 rounded-xl  mx-3 md:mx-0 px-4 pb-6">
                    ...
                    <button  className="rounded-lg w-full bg-gray-600 hover:bg-blue-600 duration-300 py-2 text-white" onClick={procceedToPayment}>
                      Procceed to Payment
                    </button>
                    </div>
                  </div>
