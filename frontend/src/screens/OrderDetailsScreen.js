        ...
        <Fragment>
          <div className="ml-2 md:ml-0 mb-7">
            ...
            <div className="mt-5 pb-4 border-b-2 ">
              ...
              <h3 className="mt-2 ml-3 font-semibold">
                Address :{" "}
                <span className="text-gray-700">{shippingDetails}</span>
              </h3>
              <h3 className="mt-2 ml-3 font-semibold">
                Amount : <span className="text-gray-700">${totalPrice}</span>
              </h3>
            </div>
                  ...
                  {orderItems &&
                    orderItems.map((item) => (
                      <tr key={item.product}>
                        ...
                        <td>
                          <h4 className="md:text-xl font-semibold md:font-bold text-blue-600">
                            ${item.price}
                          </h4>
                        </td>
                        <td>
