          ...
          >
            <div className="max-w-screen-sm mx-auto bg-gray-200 md:my-44 md:h-96 rounded-xl">
              ...
              <div className="flex justify-center">
                <button
                  className="bg-lime-600 px-3 py-1 mt-4 rounded-lg"
                ...
                <div className="right">
                  <div className="data pl-2">
                    <div className="border-b-2">
                      ...
                      <div className=" font-extralight text-blue-900 mb-3">
                        # {product._id}{" "}
                      </div>
                    ...
                    <div className="border-b-2 mb-3">
                      ...
                      <div className="flex mb-5 ">
                        <div className="flex mr-20">
                          <span
                            className="bg-gray-600 hover:bg-blue-600 duration-300 text-white p-2 flex items-center rounded-md"
                            onClick={decreaseQty}
                          >
                            <FaMinus />
                          </span>
                        ...
                        <button
                          className="bg-blue-600 text-white hover:bg-gray-600 duration-300 rounded-md py-2 px-4"
                    ...
                    <div className="border-b-2 mb-3">
                      ...
                      <div className="mb-3 font-medium text-gray-600">
                        {product.description}
                      </div>
                    </div>
                    <div className="mb-3">
