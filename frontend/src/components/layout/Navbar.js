...
<nav className="bg-gray-300 border-gray-200 px-2 sm:px-4 py-2.5">
  ...
  <div className="flex md:order-1">
    ...
    <div className="hidden relative md:block">
      ...
      <input type="text" id="search-navbar" className="block p-2 pl-10 w-full text-gray-900 bg-gray-50 rounded-lg border border-gray-300 sm:text-sm focus:ring-blue-500 focus:border-blue-500" placeholder="Search..."/>
    </div>
  ...
  <div className="hidden justify-between items-center w-full md:flex md:w-auto md:order-2" id="navbar-search">
    ...
    <button className='px-3 py-2 m-2 bg-slate-400 text-white rounded-lg' >Login</button>
    <button className='px-3 py-2 m-2 bg-slate-400 text-white rounded-lg'>Cart</button>
    </div>
